...
local HandleNetwork = {
	...
	['J'] = function(params) onPlayerConnect() UI.showNotification(params) UI.chatMessage(params, true) end, -- A player Joined
	['L'] = function(params) UI.showNotification(params) UI.chatMessage(params, true) end, -- A player left
